...
import com.heqin.proxy.UserDaoImpl;
...
public class UserDaoImpl$$EnhancerByCGLIB$$e4871da2 extends UserDaoImpl implements Factory {
    ...
    static void CGLIB$STATICHOOK1() throws ClassNotFoundException {
        ...
        Class var0 = Class.forName("com.heqin.proxy.UserDaoImpl$$EnhancerByCGLIB$$e4871da2");
        Class var1;
        ...
        CGLIB$updateName$0$Method = ReflectUtils.findMethods(new String[]{"updateName", "()V"}, (var1 = Class.forName("com.heqin.proxy.UserDaoImpl")).getDeclaredMethods())[0];
