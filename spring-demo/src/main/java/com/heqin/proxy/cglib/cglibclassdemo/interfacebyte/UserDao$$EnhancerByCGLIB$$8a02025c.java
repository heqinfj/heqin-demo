...
/**
 * @Desc 代理类，cglib实现被代理接口{@link UserDao}
 * @Author heqin
...
public class UserDao$$EnhancerByCGLIB$$8a02025c implements UserDao, Factory {
    ...
    static void CGLIB$STATICHOOK1() throws ClassNotFoundException {
        ...
        Class var0 = Class.forName("com.heqin.proxy.dao.UserDao$$EnhancerByCGLIB$$8a02025c");
        Class var1;
        ...
        CGLIB$updateName$4$Method = ReflectUtils.findMethods(new String[]{"updateName", "()V"}, (var1 = Class.forName("com.heqin.proxy.dao.UserDao")).getDeclaredMethods())[0];
